    ...
    try:
        ...
        for element in parse_json['list']:
            ...
            if "15:00:00" in str(date):
                ...
                weatherforecast_frame.pack(pady=(20, 10), side=LEFT)
...
head = Label(root, text="Check Weather", font=bold_font)
head.pack()
loc = ttk.Entry(root, width=50, justify="center")
...
weather_frame = Frame(root, highlightbackground="white", highlightthickness=4)
